...
# from models import DraftGeneratorInstance, KeywordsGeneratorInstance, TableGeneratorInstance, QnAInstance
...
async def main():
    ...
    project = Project.load_from_file(
        ...
        project_id='test_7')
    print('loaded instance: ', time.time()-start)
    answer = project.get_qna_answer(question="우크라이나 전쟁은 어떻게 진행되고 있나요?")
